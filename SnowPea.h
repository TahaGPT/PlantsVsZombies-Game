...
public:
	SnowPea()
	{
		flowerTexture.loadFromFile("Images/snowpea.png");
		flowerSprite.setTexture(flowerTexture);
		bulletTexture.loadFromFile("Images/bluepea.png");
		bulletSprite.setTexture(bulletTexture);
		inventTexture.loadFromFile("Images/snow.png");
	...
	void drawInitial(RenderWindow& window)
	{
		...
		if (unlocked)
		{
			...
			inventSprite.setPosition(0, 500);
	...
	void updateBullet() {
		...
		float moveDistance = bulletX * elapsedTime * 300;
