...
public:
	FumeShroom()
	{
		flowerTexture.loadFromFile("Images/shroom.png");
		flowerSprite.setTexture(flowerTexture);
		bulletTexture.loadFromFile("Images/purplepea.png");
		bulletSprite.setTexture(bulletTexture);
		inventTexture.loadFromFile("Images/mush.png");
	...
	void drawInitial(RenderWindow& window)
	{
		...
		if (unlocked)
		{
			...
			inventSprite.setPosition(0, 600);
	...
	void updateBullet() {
		...
		float moveDistance = bulletX * elapsedTime * 250;
